...
BEGIN
    ...
    SELECT profession1
    WHERE NOT EXISTS (SELECT 1 FROM profession AS P WHERE P.professionText = profession1); 
    
    INSERT INTO profession(professionText)
    SELECT profession2
    WHERE NOT EXISTS (SELECT 1 FROM profession AS P WHERE P.professionText = profession2); 
    
    INSERT INTO profession(professionText)
    SELECT profession3
    WHERE NOT EXISTS (SELECT 1 FROM profession AS P WHERE P.professionText = profession3); 
